                    ...
                    <div class= "col colom col-8 p-4 bg-light">
                        ...
                        <form method = "post" action = "result.php">
                            ...
                            <div class = "form-group mb-2">
                                ...
                                <input id= "nama_barang" class="form-control" type="text" placeholder="Nama Barang" />
                            ...
                            <div class = "form-group mb-2">
                                ...
                                <input id= "stok" class="form-control" type="number" placeholder="Banyak Stok" />
                            ...
                            <div class = "form-group mb-2">
                                ...
                                <textarea class="form-control" id="distributor" rows="3"></textarea>
